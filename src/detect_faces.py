...
while True:
    ...
    if len(boxes) > 1:
        # if more than 1 face detected save image
        bp = r"P:\Python Projects\FacialRecognition\Student1"
        personName = "sarvang"
        imgName = lambda _i=0: "{bp}/{personName}_{tm}.png".format(personName=personName, tm=time.time(), bp=bp)
        print("saving frame")
        Image.fromarray(frame).save(imgName(), "PNG")
